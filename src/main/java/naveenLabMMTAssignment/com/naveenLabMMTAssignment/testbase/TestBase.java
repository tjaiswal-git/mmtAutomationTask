 ...
 * file,excel reader,waiting statement,screenShoot etc.
 * 
 * @author tjaiswal
 *
 */
...
public class TestBase {
	...
	/**
	 * When a FluentWait instance is implemented it defines the maximum amount
	 * of time to wait for a condition, as well as the frequency with which to
	 * check the condition. Furthermore, the user may configure the wait to
	...
	/**
	 * This method is used for take a screen shot through webdriver with format
	 * of current time instance
	 * 
	 * @param name
	 */
	...
	public void getScreenShot(String name) {
		...
		try {
			String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()
					+ "/src/main/java/com/guru/Ecommerce/Automation/Screenshot";

			File destFile = new File(
					(String) reportDirectory + "/" + name + "_" + simpleDateFormat.format(calendar.getTime()) + ".png");
